...
fun main() {
    var game = Game(Board(File(2), File(7)), Piece.W)
...
//    println(game.board.isValidMove(move))
    ...
    println(game)
    game = game.applyMove(game.parseMove("b5", Piece.B)!!)
    println(game)
    game = game.applyMove(game.parseMove("f4", Piece.W)!!)
    println(game)
    game = game.applyMove(game.parseMove("a5", Piece.B)!!)
    println(game)
    game = game.applyMove(game.parseMove("b3", Piece.W)!!)
    println(game)
    game = game.applyMove(game.parseMove("c6", Piece.B)!!)
    println(game)
    game = game.applyMove(game.parseMove("g4", Piece.W)!!)
    println(game)
    game = game.applyMove(game.parseMove("g5", Piece.B)!!)
    println(game)
    game = game.applyMove(game.parseMove("a3", Piece.W)!!)
    println(game)
    ...
    println(game)
    game = game.applyMove(game.parseMove("g6", Piece.W)!!)
    println(game)
    val executor2 = Executors.newSingleThreadExecutor()
    println(itDeepN(game, 3, 4500, Piece.B, hash = HashMap<Game, Pair<Int, Int>>(), executor2))
    executor2.shutdown()
    ...
    println(game)
    game = game.applyMove(game.parseMove("axb4", Piece.W)!!)
    println(game)
    game = game.applyMove(game.parseMove("a4", Piece.B)!!)
    println(game)
