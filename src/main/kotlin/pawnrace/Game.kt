...
//    println(game.board.isValidMove(move))
    game = game.applyMove(game.parseMove("g3", Piece.W)!!)
    println(game)
    game = game.applyMove(game.parseMove("a6", Piece.B)!!)
    println(game)
...
//    game = game.applyMove(game.parseMove("b4", Piece.W)!!)
//    println(game)
//    println(findBestMoveN(game, 3, Piece.W, hash = HashMap<Game, Pair<Int, Int>>()))
//    game = game.applyMove(game.parseMove("g6", Piece.B)!!)
//    println(game)

    val executor = Executors.newSingleThreadExecutor()
//    println(findBestMoveN(game, 5, Piece.W, hash = HashMap<Game, Pair<Int, Int>>()))
    println(itDeepN(game, 5, 4500, Piece.W, hash = HashMap<Game, Pair<Int, Int>>(), executor))
    executor.shutdown()
}
